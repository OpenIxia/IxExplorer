...
#                                                                              #
# Description:                                                                 #
#    This sample creates a DHCPv6 three groups on two different ports, binds   #
#    them and gathers the DHCPv6 statistics from the port on which the groups  #
#    were configured.                                                          #
#                                                                              #
# Module:                                                                      #
...
set dhcp_settings_obj1 [::ixia::emulation_dhcpv6_config    \
        -mode           create          \
...
if {[keylget dhcp_settings_obj1 status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget dhcp_settings_obj1 log]"
}
set settings_handle1 [keylget dhcp_settings_obj1 handle]

set dhcp_settings_obj2 [::ixia::emulation_dhcpv6_config    \
        -mode           create          \
...
if {[keylget dhcp_settings_obj2 status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget dhcp_settings_obj2 log]"
}
set settings_handle2 [keylget dhcp_settings_obj2 handle]
...
set dhcp_group_obj3 [::ixia::emulation_dhcpv6_group_config \
        -mode           create              \
        -handle         $settings_handle2   \
        -encap          ethernet            \
        -target_subport 0                   \
...
if {[keylget dhcp_group_obj3 status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget dhcp_group_obj3 log]"
}
set group_handle3 [keylget dhcp_group_obj3 handle]
...
# Get aggregated statistics for all groups configured on ports $port_handle1
# and $port_handle2.
set dhcp_control_status [::ixia::emulation_dhcpv6_stats \
        -port_handle    [list $port_handle1 $port_handle2]                          \
        -handle         [list [list $group_handle1 $group_handle2] $group_handle3]  \
        ]       
