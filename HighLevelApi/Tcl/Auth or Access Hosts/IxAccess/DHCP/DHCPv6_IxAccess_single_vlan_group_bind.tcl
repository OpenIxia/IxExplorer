...
#     no shutdown                                                              #
# !                                                                            #
# interface GigabitEthernet1/14.800                                            #
#     encapsulation dot1Q 800                                                  #
#     ipv6 enable                                                              #
#     ipv6 dhcp server ixaccess                                                #
# !                                                                            #
# interface GigabitEthernet1/14.802                                            #
#     encapsulation dot1Q 802                                                  #
#     ipv6 enable                                                              #
#     ipv6 dhcp server ixaccess                                                #
# !                                                                            #
# interface GigabitEthernet1/14.804                                            #
...
set dhcp_group_obj [::ixia::emulation_dhcpv6_group_config \
        ...
        -sessions_per_vlan      2                   \
        -vlan_priority          4                   \
        -vlan_priority_step     3                   \
        -vlan_priority_count    2                   \
        -sessions_per_priority  3                   \
        ]
