...
#    The IxLoad video server has one video stream with synthetic payload.      #
#    The IxLoad video client performs a Join command using MLD v1 and 1200     #
#    clients are emulated.                                                     #
...
set server_network_range [::ixia::L47_network                  \
        ...
        -np_network_mask    16                                 \
    	-np_mss_enable      1                                  \
    	-np_first_mac       "00:00:B6:EC:86:B1"                \
    	-np_first_ip        "2000::2"                          \
    	-np_ip_count        1                                  \
...
set server_status [::ixia::L47_video_server             \
        ...
        -addr_incr          "0::1"                      \
    	-name               "Stream0"                   \
    	-starting_multicast_group_addr  "ff04::13"      \
    	-duration           10                          \
    	-type               "Multicast"                 \
    	-starting_dest_port 1234                        ]
    	
if {[keylget server_status status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget server_status log]"
}

set videoList_handle [keylget server_status videoList_handle]
...
set server_status [::ixia::L47_video_server             \
    	...
    	-starting_dest_port 1234                        \
    	-starting_multicast_group_addr  "ff04::13"      \
    	-mpeg_type          "MPEG2 Transport Stream"    \
    	-name               "Stream0"                   ]
...
set client_network_range [::ixia::L47_network                   \
        ...
        -np_network_mask     16                                 \
    	-np_mss_enable       1                                  \
    	-np_first_mac        "00:00:00:A7:3D:58"                \
    	-np_first_ip         "3000::2"                          \
    	-np_ip_count         1200                               \
    	-np_mac_incr_step    "00:00:00:00:00:01"                \
    	-np_ip_incr_step     "0:0:0:0:0:0:0:1"                  ]
...
set client_status [::ixia::L47_video_client                         \
    	...
    	-group_address_step             "0::1"                      \
    	-start_group_address            "FF04:0000:0000:0000:0000:0000:0000:0013" \
    	-duration_max                   600                         \
    	-duration_min                   600                         ]
