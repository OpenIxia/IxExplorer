...
#    FTP server.                                                               #
#    Client is simulating LOGIN command to the FTP server.                     #
#    Once the login is successful the client performs 10 RETRIEVE commands     #
#    On the real files from the FTP server.                                    #
#    A THINK command of 2000ms is performed.                                   #
#    After the THINK command the client simulates 10 STORE commands to the FTP #
#    server using the 10 real files added.                                     #
#    A THINK command of 2000ms is performed.                                   #
#    A QUIT command is simulated.                                              #
