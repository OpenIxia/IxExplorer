...
#                                                                              #
# Description:                                                                 #
#    This sample creates a TELNET client and server configuration.             #
#    The client networks is configured using DHCP.                             #
...
#     |     Ixia chassis   |  | 6500            |                              #
#     ----------------------  ------------------|                              #
#     |4/3 ixia_client_port|--| switchport 9/37 |                              #
#     |                    |  |                 |  ___________________         #
#     |4/4 ixia_server_port|--| switchport 9/38 |  | 7200            |         #
#     |____________________|  |                 |  ------------------|         #
#                             | switchport 9/39 |--| 3/0 dhcp server |         #
...
#  configure terminal
#     default interface gigabitEthernet 9/37
#     default interface gigabitEthernet 9/38
#     default interface gigabitEthernet 9/39
...
#         ip dhcp pool ixiaPool
#         network 26.26.26.0 255.255.255.0
#         exit
#       ip dhcp excluded-address 26.26.26.254
#         default interface fa 3/0
#         int fa 3/0
...
set client_network_range [::ixia::L47_network                     \
        ...
        -np_enable_stats             1                          \
        -np_range_type               dhcp                       \
        -np_first_server_reply       1                          \
        -np_server_ip                "26.26.26.1"                 \
        -np_timeout                  60                         \
        -np_max_outstanding_requests 1000                       \
        -np_max_client_per_second    100                        ]
