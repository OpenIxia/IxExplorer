...
#                                                                              #
# Description:                                                                 #
#    This sample creates a cc groups and configures two session group on the   #
#    cc group. Then it deletes the first session group.                        #
#                                                                              #
# Module:                                                                      #
...
###################################################
#  Configure a L2TPv3 control connection groups   #
###################################################
...
#########################################################
#  Configure two L2TPv3 session groups with two         #
...
set l2tpv3_session_status [::ixia::l2tpv3_session_config \
        ...
        -vlan_id                     100               \
        -vlan_id_step                1                 \
        -mac_src                     0000.5555.6666    \
        -mac_src_step                0000.0000.0001    \
        -mac_dst                     0000.7777.8888    \
        -mac_dst_step                0000.0000.0001    ]
if {[keylget l2tpv3_session_status status] != $::SUCCESS} {
    return "FAIL - $test_name - [keylget l2tpv3_session_status log]"
}
...
#################################################
#  Delete the first session group               #
#################################################
set l2tpv3_delete_status [::ixia::l2tpv3_session_config \
        -action               delete                  \
