...
#                                                                              #
# Description:                                                                 #
#    This sample creates a DHCPv6 group, binds it, releases it and gathers     #
#    the DHCPv6 statistics from the port on which the group was configured.    #
#                                                                              #
# Module:                                                                      #
...
# Release the IPv6 addresses of the clients emulated on port $port_handle.
set dhcp_port_status [::ixia::emulation_dhcpv6_control \
        -port_handle    $port_handle    \
        -bind           release         \
        ]       
