...
#    using ethernet_ii_vlan encapsulation.                                     #
#    Then it writes the config to hardware.                                    #
#                                                                              #
# Module:                                                                      #
...
#
#    ipv6 dhcp pool dhcp-pool-vlan
#
#    prefix-delegation pool client-prefix-pool-vlan lifetime 1800 600
#    dns-server 2001:0DB8:3000:3000::42
#    domain-name examplecom
#    exit
#    int g1/38.1
...
#    ipv6 address FEC0:240:104:2301::139/64
#    ipv6 dhcp server dhcp-pool-vlan
#    exit
#    ipv6 local pool client-prefix-pool-vlan 2001:0DB8:1200::/40 48
################################################################################
