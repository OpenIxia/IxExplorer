...
#    using TCP and BHCA.                                                       #
#    Client is simulating an ORIGINATECALL scenario an ENDCALL sccenario.      #
...
set server_network_range [::ixia::L47_network              \
        ...
        -property           network_pool                 \
        -mode               add                          \
        -np_first_ip        "198.18.101.0"               \
        -np_ip_count        2000                         \
        -np_network_mask    "255.255.0.0"                \
        -np_gateway         "0.0.0.0"                    \
        -np_ip_incr_step    "0.0.0.1"                    \
        -np_first_mac       "10:C6:12:02:02:00"          \
        -np_mac_incr_step   "00.00.00.00.00.01"          ]
