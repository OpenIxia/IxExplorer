...
#                                                                              #
# Description:                                                                 #
#    This sample creates a HTTP client and server configuration with ssl       #
#    enabled.Client is simulating a PUT(SSL) command.No routers are emulated.  #
...
set http_client_action [::ixia::emulation_http_traffic_type_config        \
        ...
        -arguments                    {/home/testuser/testfile.put}       \
        -abort                        none                                \
...
set http_client_map [::ixia::emulation_http_control_config                    \
        ...
        -ramp_up_type          max_pending_users                     \
        -ramp_up_value         10                                    \
        -client_standby_time   3                                     \
        -client_sustain_time   80                                    \
        -ramp_down_time        20                                    \
        -client_total_time     102                                   ]
...
set http_control [::ixia::emulation_http_control                            \
        ...
        -results_dir            {/home/testuser/http_results_dir}        \
